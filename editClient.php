...
<body>
    <form action="editClient.php" method="post">
        <h1><img src="images/small_logo.png" width="80px"><br>Details</h1>
    ...
    <p><?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "Update clients 
					SET	firstName = '$name',  lastName = '$lname', emailAddress = '$email', contactNumber = '$contact', passwords = '$password' 
